...
/* harmony import */ var _core_components_calendar_event_calendar_event_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./core/components/calendar-event/calendar-event.component */ "./src/app/core/components/calendar-event/calendar-event.component.ts");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 8, vars: 6, consts: [[1, "date-container"], ["name", "selMonth", 3, "ngModel", "ngModelChange"], ["selMonth", ""], [3, "value", 4, "ngFor", "ngForOf"], [1, "year"], [3, "year", "monthIndex", "events"], [3, "value"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "select", 1, 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_select_ngModelChange_1_listener($event) { return ctx.selectedMonth = $event; });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        _core_components_calendar_event_calendar_event_component__WEBPACK_IMPORTED_MODULE_3__["CalendarEventComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _core_components_calendar_event_calendar_event_component__WEBPACK_IMPORTED_MODULE_3__["CalendarEventComponent"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"]
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _shared_date_helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../shared/date-helpers */ "./src/app/core/shared/date-helpers.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");




function CalendarEventComponent_span_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const dayName_r2 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("", dayName_r2, " ");
} }
const _c0 = function (a0, a1, a2) { return { "prev-month": a0, "has-event": a1, today: a2 }; };
function CalendarEventComponent_span_2_Template(rf, ctx) { if (rf & 1) {
...
class CalendarEventComponent {
    ...
    setCalendar() {
        this.calendarDays = [];
        const MONDAY = 1;
        const daysInMonth = Object(_shared_date_helpers__WEBPACK_IMPORTED_MODULE_1__["getDaysInMonth"])({ month: this.monthIndex });
        const firstDayWeek = Object(_shared_date_helpers__WEBPACK_IMPORTED_MODULE_1__["getFirstDayOfWeek"])({ month: this.monthIndex });
        // build the previous month left days
        if (firstDayWeek > MONDAY) {
            debugger;
            const daysInPrevMont = Object(_shared_date_helpers__WEBPACK_IMPORTED_MODULE_1__["getDaysInMonth"])({ month: this.monthIndex - 1 });
        ...
        // set current day
        const calendarToday = this.calendarDays.find(d => Object(_shared_date_helpers__WEBPACK_IMPORTED_MODULE_1__["isToday"])({
            day: d.value,
    ...
    attachEvent(dayIndex) {
        const makeStringDate = (d) => `${d.getFullYear()}-${d.getMonth()}-${d.getDay()}`;
...
CalendarEventComponent.ɵfac = function CalendarEventComponent_Factory(t) { return new (t || CalendarEventComponent)(); };
CalendarEventComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CalendarEventComponent, selectors: [["calendar-event"]], inputs: { year: "year", monthIndex: "monthIndex", events: "events" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 9, vars: 5, consts: [[1, "calendar"], ["class", "day day-header", 4, "ngFor", "ngForOf"], ["class", "day", 3, "ngClass", "title", 4, "ngFor", "ngForOf"], [1, "day", "day-header"], [1, "day", 3, "ngClass", "title"]], template: function CalendarEventComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
function getDaysInMonth({ year = currentYear, month }) {
    return new Date(+year, +month + 1, 0).getDate();
}
function getFirstDayOfWeek({ year = currentYear, month }) {
    return new Date(+year, +month, 1).getDay();
}
function isToday({ year = currentYear, month, day }) {
...
module.exports = __webpack_require__(/*! /Users/Shared/x_devs/_github/Angular_Projects/packages/calendar-manager/src/main.ts */"./src/main.ts");
